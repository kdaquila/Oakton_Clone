        ...
        <header>
            <div className={s['header__row1']}>
                <div className={s['callToAction']}>
                    <HoverDropDown customComponent={s['callToActionWidget']}
                                   customHeading={s['callToActionWidget__heading']}
                                   customMenu={s['callToActionWidget__menu']}
                                   customLink={s['callToActionWidget__link']}
                                   customItem={s['callToActionWidget__item']}
                                   title="Visit"
                                   menuItems={{
                                       "Des Plaines": "#",
                                       "Skokie": "#",
                ...
                <form className={s.search} action="" method="get">
                    ...
                    <button className={s.search__button} type="submit"><span className={s.search__icon}/></button>
                </form>
            </div>
            <div className={s.header__row2}>
                <img className={s.logo} src={logo} alt="oakton logo"/>
                <ul className={s.rolesList}>
                    <li className={s.rolesList__item}><a href="#">New Students</a></li>
                    <li className={s.rolesList__item}><a href="#">Current Students</a></li>
                    <li className={s.rolesList__item}><a href="#">Faculty & Staff</a></li>
                </ul>
                <ul className={s.rolesList}>
                    <li className={s.rolesList__item}><a href="#">The Community</a></li>
                    <li className={s.rolesList__item}><a href="#">Business & Industry</a></li>
                    <li className={s.rolesList__item}><a href="#">Oakton Alumni</a></li>
                </ul>
            </div>
